...
const prompt = ai.definePrompt({
  ...
  prompt: `Olá! Sou o Eustáquio, seu assistente previdenciário. Sou especialista em saúde e segurança do trabalho com foco em direito previdenciário. Minha tarefa é analisar um documento PPP (Perfil Profissiográfico Previdenciário) e extrair as informações mais críticas para você.
